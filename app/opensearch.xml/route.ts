...
<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/">
  ...
  <Description>Search ${siteConfig.name} — Sheet Metal Fabrication, CNC Bending &amp; Laser Cutting services in Surat</Description>
  ...
  <Query role="example" searchTerms="sheet metal bending"/>
  <Developer>${siteConfig.legalName}</Developer>
  <Contact>${siteConfig.email}</Contact>
  <Tags>sheet metal bending CNC laser cutting fabrication Surat Gujarat India</Tags>
