...
const title = "Sheet Metal Bending Products Manufacturer Surat | Base Plates, Foundation Bolts, Purlins & Perforated Sheets | Balaji Engineering Works";
const description =
  "Balaji Engineering Works manufactures sheet metal bending products in Surat — MS base plates, foundation bolts, anchor bolts, Z/C purlins, perforated sheets, decking sheets, corrugated roofing sheets, walkway planks, conveyor stringers, and steel pallets.";
