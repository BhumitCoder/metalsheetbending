...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildMetadata({
    title:
      count > 0
        ? `Sheet Metal Bending Gallery - ${count} CNC Laser Cutting & Fabrication Photos | Balaji Engineering Works Surat`
        : "Sheet Metal Bending Gallery - CNC Laser Cutting & Fabrication Photos | Balaji Engineering Works Surat",
    description:
      count > 0
        ? `Browse ${count} photos of sheet metal bending, CNC laser cutting, plate bending, welding, plasma cutting, and finished industrial products from Balaji Engineering Works in Surat, Gujarat.`
        : "Browse photos of sheet metal bending, CNC laser cutting, plate bending, welding, plasma cutting, and finished industrial products from Balaji Engineering Works in Surat, Gujarat.",
    path: "/gallery",
    keywords: [
